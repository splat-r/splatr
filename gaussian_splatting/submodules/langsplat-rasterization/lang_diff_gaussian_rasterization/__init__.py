...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def backward(ctx, grad_out_color, grad_out_language_feature, _):
        ...
        # updating only visible gaussians
        # grad_lang_fts = torch.zeros_like(grad_language_feature_precomp)
        # grad_lang_fts[radii > 0] = grad_language_feature_precomp[radii > 0]
