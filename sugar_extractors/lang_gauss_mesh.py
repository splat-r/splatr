...
def extract_mesh_from_lang_gaussians(args):
    ...
    if args.mesh_output_dir is None:
        if len(args.scene_path.split("/")[-1]) > 0:
            args.mesh_output_dir = os.path.join("./output/lang_gauss_mesh", args.scene_path.split("/")[-1])
        else:
            args.mesh_output_dir = os.path.join("./output/lang_gauss_mesh", args.scene_path.split("/")[-2])
    ...
    if use_vanilla_3dgs:
        ...
        o3d_mesh_new = o3d.io.read_triangle_mesh(args.lang_sugar_mesh_path)
