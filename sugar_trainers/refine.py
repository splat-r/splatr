...
def refined_training(args):
    ...
    if regularize_sdf:
        ...
        start_sdf_regularization_from = 100
        ...
        if use_sdf_estimation_loss or enforce_samples_to_be_on_surface:
            ...
            start_sdf_estimation_from = 100  # 7000
    ...
    if regularize_sdf:
        ...
        regularize_from = 100  # 0 until now
        start_reset_neighbors_from = 100+1  # 0 until now (should be equal to regularize_from + 1?)
        ...
        for i in range(0, train_num_images, train_num_images_per_batch):
            ...
            if not no_rendering:
                ...
                if not args.include_feature:
                    ...
                    # print("regularize sdf : ", regularize_sdf)
                    # print("iteration : ", iteration)
                    # print("regulaize from : ", regularize_from)
                    # print("start_sdf_regularization_from : ", start_sdf_regularization_from)
                    # print("use_sdf_estimation_loss :", use_sdf_estimation_loss )
                    # print("enforce_samples_to_be_on_surface : ", enforce_samples_to_be_on_surface)
                    # print("start_sdf_estimation_from : ", start_sdf_estimation_from)
                    # print("use_sdf_better_normal_loss : ", use_sdf_better_normal_loss)
                    # print("enforce_samples_to_be_on_surface : ", enforce_samples_to_be_on_surface)
