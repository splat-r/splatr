...
class OptimizationParams():
    def __init__(self, 
        ...
        self.language_feature_lr = language_feature_lr
        self.sim_vec_lr = sim_vec_lr
    ...
    def __str__(self):
        return f"""OptimizationParams(
            ...
            language_feature_lr={self.language_feature_lr},
            sim_vec_lr={self.sim_vec_lr},
            )"""
    ...
    def __init__(
        ...
        if not include_sim:
            if not include_feature:
                ...
                l = [
                    {'params': [model._language_feature], 'lr': opt.language_feature_lr, "name": "language_feature"}
                ]
        else:
            l = [
                {'params': [model.sim_vec], 'lr': opt.sim_vec_lr, "name": "similarity_vector"},
            ]
