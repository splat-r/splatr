...
from rearrange.rearrange.constants import STEP_SIZE
from rearrange.rearrange.environment import RearrangeTHOREnvironment
from rearrange.rearrange.tasks import (
    UnshuffleTask,
    WalkthroughTask,
...
class InWalkthroughPhaseSensor(
    ...
    def __init__(self, uuid: str = "in_walkthrough_phase", **kwargs: Any):
        observation_space = gym.spaces.Box(
            low=False, high=True, shape=(1,), dtype=np.bool_
        )
